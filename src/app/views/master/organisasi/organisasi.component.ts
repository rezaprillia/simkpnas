...
import {Search} from './organisasi.model';
...
export class OrganisasiComponent implements AfterViewInit {
  ...
  constructor(
    ...
    @Inject(OrganisasiService) private roleService: OrganisasiService
  ) {
    this.search = {
      idorg: '',
      parent_idorg: '',
