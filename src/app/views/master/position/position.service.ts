...
import { Role, KategoriAktif } from './position.model';
...
@Injectable()
export class PositionService {
  private resourceUrlVisi = this.a.SERVER_URL + '/master/Position';
  ...
  getById(id: any): Observable<any> {
    ...
    return this.http.get(this.resourceUrlVisi + '/retrieve?token=' + token + '&idpos=' + "'" + id + "'")
  }
  ...
  delete(data: any): Observable<any> {
    ...
    const token = localStorage.getItem('token');
    return this.http.get(this.resourceUrlVisi + '/delete?token=' + token + '&idpos=' + data.idpos)
  }
