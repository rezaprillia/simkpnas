...
import { Role, KategoriAktif } from './posisi-organisasi.model';
...
@Injectable()
export class PosisiOrganisasiService {
  private resourceUrlVisi = this.a.SERVER_URL + '/system/MasterPosisiOrganisasi';
  ...
  getById(id: any): Observable<any> {
    ...
    //primary key disini adalah string, jadi id harus dijadikan string dengan cara "'"+id+"'"
  }
