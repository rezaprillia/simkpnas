...
import {Menu, Role, KategoriAktif} from '../role.model';
...
import { DxiItemComponent } from 'devextreme-angular/ui/nested/item-dxi';
 ...
 export class AddRoleComponent implements OnInit, AfterViewInit, AfterContentInit {
   @Input() isEdit;
   @Input() isDetail;
   @Input() editItem;
   @Input() addVisible;
    ...
    if (this.isEdit || this.isDetail) {
      ...
      this.roleService.getById(this.editItem).subscribe(respRole => {
        ...
        this.role = {
          ...
          keterangan: respRole.d.keterangan,
          isallowregistration: respRole.d.isallowregistration,
          isdisplayed: parseInt(nilai, 10),
          activationCode: respRole.d.activationCode,
          createdby: null,
          createdate: null,
          updatedby: null,
          updatedate: null
