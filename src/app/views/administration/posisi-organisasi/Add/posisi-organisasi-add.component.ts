...
import { DxiItemComponent } from 'devextreme-angular/ui/nested/item-dxi';
 ...
 @Component({
   selector: 'app-add-posisi-organisasi',
   templateUrl: './posisi-organisasi-add.component.html',
   providers: []
 })
 export class AddOrganisasi implements OnInit, AfterViewInit, AfterContentInit {
  ...
  checkBoxToggled(e) {
   ...
   onSaveConf() {
     ...
     console.log('isdisplayed sebelum disave = ' + this.role.created_by);
     const nilai: number = this.role.created_by;
    //  this.role.isdisplayed = nilai.toString();
     let success = false;
     if (!this.isEdit) {
       this.role.idorg = null;
